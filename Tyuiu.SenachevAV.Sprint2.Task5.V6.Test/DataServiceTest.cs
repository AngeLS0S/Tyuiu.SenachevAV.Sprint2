...
namespace Tyuiu.SenachevAV.Sprint2.Task5.V6.Test
{
    ...
    public class DataServiceTest
    {
        ...
        public void ValidFindCardNameAndValue()
        {
            ...
            Assert.AreEqual("Шестёрка червей", ds.FindCardNameAndValue(4, 6));
            ...
            Assert.AreEqual("Семёрка червей", ds.FindCardNameAndValue(4, 7));
            ...
            Assert.AreEqual("Восьмёрка червей", ds.FindCardNameAndValue(4, 8));
            ...
            Assert.AreEqual("Десятка червей", ds.FindCardNameAndValue(4, 10));
            ...
            Assert.AreEqual("Туз червей", ds.FindCardNameAndValue(4, 14));
